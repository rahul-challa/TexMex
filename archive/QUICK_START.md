...
4. **First time only**: TexMex downloads its bundled LaTeX engine (~10-22MB) — no LaTeX install needed
5. **See your PDF** render automatically as you edit!
...
- **Engine download stuck or failed?** Check your internet connection, then run **TexMex: Reinstall LaTeX Engine**
- **Preview not updating?** Check `texmex.updateDelay` setting
- **Peer sync failing?** Verify port 3000 isn't blocked
- **Compilation errors?** Run **TexMex: Show Compiler Log** for the full LaTeX log
